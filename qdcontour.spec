...
BuildRequires: libsmartmet-newbase >= 8.9.29-1, libsmartmet-imagine >= 8.9.29-1, libsmartmet-tron >= 8.9.24-1, freetype-devel, libjpeg-devel, libpng-devel, zlib-devel, glibc-devel
